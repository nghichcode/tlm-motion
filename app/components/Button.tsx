...
const $viewPresets = {
  ...
  filledSuccess: [$baseViewStyle, { backgroundColor: colors.palette.angry500 }] as StyleProp<ViewStyle>,
...
const $textPresets: Record<Presets, StyleProp<TextStyle>> = {
  ...
  filledSuccess: [$baseTextStyle, { color: colors.palette.neutral100 }],
}
...
const $pressedViewPresets: Record<Presets, StyleProp<ViewStyle>> = {
  ...
  filledSuccess: { backgroundColor: colors.palette.angry500 },
}
